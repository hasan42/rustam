//npm i gulp --save-dev
//npm i --save-dev gulp-less browser-sync gulp-concat gulp-uglify gulp-cssnano gulp-rename del gulp-imagemin imagemin-pngquant gulp-cache gulp-autoprefixer
...
var gulp = require('gulp'), // Подключаем Gulp
    ...
    gulpstylelint = require('gulp-stylelint'), // Подключаем библиотеку styleint
    cache = require('gulp-cache'), // Подключаем библиотеку кеширования;
